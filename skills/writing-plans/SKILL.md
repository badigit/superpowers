...
**Context:** If working in an isolated worktree, it should have been created via the `superpowers-dim:using-git-worktrees` skill at execution time.
...
- **REQUIRED SUB-SKILL:** Use superpowers-dim:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use superpowers-dim:executing-plans
